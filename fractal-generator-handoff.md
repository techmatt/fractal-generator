...
`C:\Code\fractal-generator` · corpus `C:\Users\techm\Desktop\Wallpapers\` (top-level) · `out/corpus/targets.json` · `out/corpus/corpus_features.json` · `out/search/search.json` (no native interior/boundary yet) · `out/wallpaper/wallpaper.json` · `assets/palettes/{sample.ugr,sample.map}`. Deepest Prompt-9 frame for reference: center ≈ `(−0.029, 0.764)`, width `2.794e-9`, mag `1.07e9`, maxiter `14546` (its `wallpaper.json` hp strings re-render any treatment).
